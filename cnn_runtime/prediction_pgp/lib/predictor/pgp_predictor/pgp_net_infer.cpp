...
// int PGPNetRun(PredictionNetInput &prediction_net_input, PredictedNetParam &prediction_net_param, float &traj) {
...
//     prediction_net_param.model_path = "./pgp.onnx";
...
//     prediction_net_param.input_node_names = {"input.1", "input.7", "lane_node_masks", \
//                                                   "f4", "nbr_vehicle_masks", "f6", "nbr_ped_masks", \
//                                                   "f8", "f9", "9", "edge_type"};
//     prediction_net_param.output_node_names = {"2180"};
